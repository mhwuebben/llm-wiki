...
- **Change what is blocked** — schema §1's *Out of scope* list is yours: ask *"stop blocking <category>"* or *"also block <category>"*, and the change is made to the schema and logged.
