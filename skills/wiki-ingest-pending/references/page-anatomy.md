...
- Length: most pages 300–800 words. Past schema §10's **Split past** line (~1,200 words if it has none), not counting `## History` or `## Version history`, split along the natural seam and link both halves — `references/propagation.md`, *Splitting and merging*.
